  ...
  return (
    <main className="light-page profile-page">
      ...
      <section className="learning-preferences-card">
        ...
        <label>Objetivo principal<select value={learningPreferences.studyGoal} onChange={(event) => updateLearningPreference('studyGoal', event.target.value)}><option value="vestibular">Vestibular</option><option value="enem">ENEM</option><option value="school_exam">Prova da escola</option><option value="general">Revisão geral</option></select></label>
