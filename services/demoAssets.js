...
// install.
//
// Metro resolves `require()` of an image at build time, so these 15 files are
// bundled and work with no network (Demo Mode's whole point). They are
// downscaled copies of web/public/demo-assets (800px, ~1.2MB total vs 5.9MB
...
// http(s) URLs such as YouTube thumbnails).
